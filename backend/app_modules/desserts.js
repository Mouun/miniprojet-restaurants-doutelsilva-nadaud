...
exports.findDesserts = function (page, pagesize, name, req, res) {
...
exports.findDessertsById = function (ids, req, res) {
    MongoClient.connect(url, function (err, client) {
        const db = client.db(dbName);
        if (!err) {
            let myquery;
            ...
            db.collection("desserts")
              ...
              .toArray()
              .then(arr => {
                  response.baseResponse(200, "Desserts details", arr, res);
              })
        } else {
